  ...
  return (
    <div className = 'w-full h-[100vh] absolute z-50 top-0 flex justify-center items-center'>
      ...
      >
        ...
        {
          loginSignup === 'login' ? <Login setLoading={setLoading} loginsignuphandle={loginsignuphandle} handleFormClose={handleFormClose}/> : <SignUp setLoading={setLoading} loginsignuphandle={loginsignuphandle} handleFormClose={handleFormClose}/>
        }
      </motion.div>
