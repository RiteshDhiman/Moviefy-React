...
const Footer = () => {
  return (
    <div className='w-full bg-black'>
      <ContentCenter>
        <div className='w-full py-12 flex flex-col gap-2 md:flex-row mt-24'>

          {/* <div className='w-full flex justify-center items-center md:w-1/3'>
            <img src={moviefy} className="w-2/3 md:w-full" />
          </div> */}

          <div className='font-monoton text-5xl 2xl:text-6xl uppercase cursor-pointer text-white w-full md:w-1/3'>Moviefy</div>
