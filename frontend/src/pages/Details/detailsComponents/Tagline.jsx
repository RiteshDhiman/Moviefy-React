...
//   asdf;
  return (
    <div className="w-full h-full bg-[#1e293b] rounded-3xl flex flex-col items-center py-5 gap-2">
        <span className="text-[#C3E200] font-oswald uppercase text-2xl font-medium">TAGLINE</span>
        <div className=" h-full flex items-center justify-center text-center text-lg md:text-2xl">
